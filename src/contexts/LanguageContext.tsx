...
const translations = {
  ar: {
    ...
    'nav.recommendations': 'الخيارات',
    'nav.precise': 'التوصيات',
    ...
    'nav.referral.desc': 'قم بدعوة أصدقائك واحصل على مكافآت',
    ...
    'settings.passwordTooShort': 'كلمة المرور يجب أن تكون 8 أحرف على الأقل',
    'settings.passwordTooWeak': 'كلمة المرور ضعيفة جداً. استخدم أحرف كبيرة وصغيرة وأرقام ورموز',
    'settings.weakPassword': '⚠️ ضعيفة',
    'settings.mediumPassword': '⚡ متوسطة',
    'settings.strongPassword': '✅ قوية',
    ...
    'login.or': 'أو',
    'login.googleButton': 'متابعة مع Google',
    'login.googleLoading': 'جاري تسجيل الدخول بـ Google...',
    ...
    'register.or': 'أو',
    'register.googleButton': 'التسجيل مع Google',
    'register.googleLoading': 'جاري التسجيل بـ Google...',
    ...
    'emailVerified.title': 'تم تفعيل بريدك الإلكتروني بنجاح!',
    'emailVerified.success': 'تم التفعيل بنجاح',
    'emailVerified.message': 'تم تفعيل حسابك بنجاح. يمكنك الآن تسجيل الدخول والبدء في استخدام جميع ميزات المنصة.',
    'emailVerified.loginButton': 'تسجيل الدخول الآن',
    'emailVerified.autoRedirect': 'سيتم التوجيه تلقائياً خلال',
    'emailVerified.seconds': 'ثوانٍ',
    'emailVerified.info': 'إذا لم يتم التوجيه تلقائياً، يمكنك الضغط على زر تسجيل الدخول أعلاه.',
    ...
    'trading.winRateShort': 'معدل الفوز',
    ...
    'referral.subtitle': 'شارك رابطك واحصل على مكافآت',
    'referral.yourLink': 'رابط الإحالة الخاص بك',
    'referral.yourCode': 'كود الإحالة الخاص بك',
    'referral.copy': 'نسخ',
    'referral.copied': 'تم النسخ!',
    'referral.shareText': 'انضم إلى منصة التداول باستخدام رابط الإحالة الخاص بي!',
    'referral.shareTitle': 'رابط الإحالة',
    'referral.totalReferrals': 'إجمالي الإحالات',
    'referral.completed': 'مكتملة',
    'referral.pending': 'قيد الانتظار',
    'referral.totalRewards': 'إجمالي المكافآت',
    'referral.referralsList': 'قائمة الإحالات',
    'referral.noReferrals': 'لا توجد إحالات حتى الآن',
    'referral.shareToStart': 'شارك رابطك لتبدأ في كسب المكافآت',
    'referral.pendingUser': 'مستخدم قيد الانتظار',
    'referral.howItWorks': 'كيف يعمل البرنامج؟',
    'referral.step1': 'شارك رابط الإحالة الخاص بك مع أصدقائك',
    'referral.step2': 'عندما يسجلون ويشتركون، تحصل على مكافأة',
    'referral.step3': 'كلما زاد عدد الإحالات، زادت مكافآتك',
    'referral.pendingCommissions': 'عمولاتك المستحقة',
    'referral.commissionsInfo': 'سيتم دفعها كل 15 يوم',
    'referral.couponUsage': 'يمكن للمستخدمين استخدام هذا الكود ككوبون خصم في صفحة الدفع',
    'referral.share': 'مشاركة',
    'referral.shareVia': 'مشاركة عبر',
    'referral.whatsapp': 'واتساب',
    'referral.telegram': 'تيليجرام',
    'referral.facebook': 'فيسبوك',
    'referral.twitter': 'تويتر',
    'referral.email': 'البريد الإلكتروني',
    'referral.date': 'التاريخ',
    'referral.reward': 'المكافأة',

    // طرق استلام العمولات
    'paymentMethod.title': 'طرق استلام العمولات',
    'paymentMethod.subtitle': 'حدد طريقة استلام عمولاتك',
    'paymentMethod.addMethod': 'إضافة طريقة',
    'paymentMethod.addNew': 'إضافة طريقة دفع جديدة',
    'paymentMethod.editMethod': 'تعديل طريقة الدفع',
    'paymentMethod.selectType': 'نوع طريقة الدفع',
    'paymentMethod.paypal': 'PayPal',
    'paymentMethod.bankTransfer': 'تحويل بنكي',
    'paymentMethod.westernUnion': 'Western Union',
    'paymentMethod.cryptocurrency': 'عملة رقمية',
    'paymentMethod.other': 'أخرى',
    'paymentMethod.paypalEmail': 'بريد PayPal الإلكتروني',
    'paymentMethod.bankName': 'اسم البنك',
    'paymentMethod.accountHolder': 'اسم صاحب الحساب',
    'paymentMethod.accountNumber': 'رقم الحساب',
    'paymentMethod.iban': 'IBAN',
    'paymentMethod.swiftCode': 'SWIFT Code',
    'paymentMethod.fullName': 'الاسم الكامل',
    'paymentMethod.country': 'الدولة',
    'paymentMethod.city': 'المدينة',
    'paymentMethod.phone': 'رقم الهاتف',
    'paymentMethod.cryptoType': 'نوع العملة',
    'paymentMethod.walletAddress': 'عنوان المحفظة',
    'paymentMethod.details': 'تفاصيل طريقة الدفع',
    'paymentMethod.save': 'حفظ',
    'paymentMethod.cancel': 'إلغاء',
    'paymentMethod.saving': 'جاري الحفظ...',
    'paymentMethod.primary': 'الافتراضية',
    'paymentMethod.verified': 'موثقة',
    'paymentMethod.setPrimary': 'تعيين كافتراضية',
    'paymentMethod.edit': 'تعديل',
    'paymentMethod.delete': 'حذف',
    'paymentMethod.noMethods': 'لم تقم بإضافة أي طريقة دفع بعد',
    'paymentMethod.deleteConfirm': 'هل أنت متأكد من حذف طريقة الدفع هذه؟',
    'paymentMethod.note': 'سيتم استخدام طريقة الدفع الافتراضية لتحويل عمولاتك. تأكد من صحة المعلومات لتجنب أي تأخير في الدفع.',
    'paymentMethod.notSet': 'لم يتم تحديد طريقة دفع',
    'paymentMethod.required': 'الحقول المطلوبة',

    // نظام الكوبونات
    'coupon.management': 'إدارة الكوبونات',
    'coupon.subtitle': 'إنشاء وإدارة كوبونات الخصم',
    'coupon.addNew': 'إضافة كوبون جديد',
    'coupon.totalCoupons': 'إجمالي الكوبونات',
    'coupon.active': 'نشطة',
    'coupon.inactive': 'غير نشطة',
    'coupon.expired': 'منتهية',
    'coupon.totalUses': 'إجمالي الاستخدامات',
    'coupon.code': 'الكود',
    'coupon.discount': 'الخصم',
    'coupon.uses': 'الاستخدامات',
    'coupon.validUntil': 'صالح حتى',
    'coupon.status': 'الحالة',
    'coupon.actions': 'الإجراءات',
    'coupon.noExpiry': 'بدون انتهاء',
    'coupon.deactivate': 'إلغاء التفعيل',
    'coupon.activate': 'تفعيل',
    'coupon.edit': 'تعديل',
    'coupon.delete': 'حذف',
    'coupon.noCoupons': 'لا توجد كوبونات حتى الآن',
    'coupon.addCoupon': 'إضافة كوبون',
    'coupon.editCoupon': 'تعديل كوبون',
    'coupon.discountType': 'نوع الخصم',
    'coupon.percentage': 'نسبة مئوية',
    'coupon.fixedAmount': 'مبلغ ثابت',
    'coupon.discountValue': 'قيمة الخصم',
    'coupon.maxUses': 'الحد الأقصى للاستخدامات',
    'coupon.optional': 'اختياري',
    'coupon.unlimited': 'غير محدود',
    'coupon.update': 'تحديث',
    'coupon.create': 'إنشاء',
    'coupon.cancel': 'إلغاء',
    'coupon.confirmDelete': 'هل أنت متأكد من حذف هذا الكوبون؟',
    'coupon.haveCode': 'لديك كود خصم؟',
    'coupon.enterCode': 'أدخل كود الكوبون',
    'coupon.apply': 'تطبيق',
    'coupon.checking': 'جاري التحقق...',
    'coupon.applied': 'تم تطبيق الكوبون',
    'coupon.invalid': 'كود الكوبون غير صحيح',
    'coupon.maxUsesReached': 'تم الوصول للحد الأقصى لاستخدام هذا الكوبون',
    'coupon.alreadyUsed': 'لقد استخدمت هذا الكوبون من قبل',
    'coupon.error': 'حدث خطأ أثناء التحقق من الكوبون',
    'coupon.discountRate': 'نسبة الخصم',
    'coupon.commissionRate': 'نسبة العمولة',
    'coupon.discountRateDesc': 'للمستخدم الجديد (افتراضي: 10%)',
    'coupon.commissionRateDesc': 'لصاحب الكوبون (افتراضي: 10%)',
    'coupon.add': 'إضافة',

    // إدارة العمولات
    'commission.management': 'إدارة العمولات',
    'commission.subtitle': 'مراجعة ودفع عمولات الإحالة',
    'commission.total': 'إجمالي',
    'commission.pending': 'قيد الانتظار',
    'commission.totalPending': 'مستحقة',
    'commission.totalPaid': 'مدفوعة',
    'commission.searchByName': 'بحث بالاسم أو البريد',
    'commission.filterByStatus': 'تصفية حسب الحالة',
    'commission.all': 'الكل',
    'commission.selectAll': 'تحديد الكل',
    'commission.paySelected': 'دفع المحدد',
    'commission.noCommissions': 'لا توجد عمولات',
    'commission.referrer': 'المحيل',
    'commission.amount': 'المبلغ',
    'commission.subscription': 'الاشتراك',
    'commission.rate': 'النسبة',
    'commission.status': 'الحالة',
    'commission.date': 'التاريخ',
    'commission.paidDate': 'تاريخ الدفع',
    ...
    'commission.bankTransfer': 'تحويل بنكي',
    'commission.paypal': 'PayPal',
    'commission.cryptocurrency': 'عملة رقمية',
    'commission.cash': 'نقداً',
    'commission.notes': 'ملاحظات',
    'commission.notesPlaceholder': 'أضف ملاحظات (اختياري)',
    'commission.confirmPayment': 'تأكيد الدفع',
    'commission.cancel': 'إلغاء',
    'commission.selectCommissions': 'الرجاء اختيار عمولات للدفع',
    'commission.paymentSuccess': 'تم دفع العمولات بنجاح',
    ...
    'payment.originalPrice': 'السعر الأصلي',
    ...
    'terms.services.content': 'نوفر إشارات تداول تعليمية مبنية على الذكاء الاصطناعي.',
  ...
  en: {
    // Navigation
    'nav.signals': 'Signals',
    'nav.recommendations': 'Options',
    'nav.precise': 'Recommendations',
    ...
    'settings.passwordTooWeak': 'Password is too weak. Use uppercase, lowercase, numbers and symbols',
    'settings.weakPassword': '⚠️ Weak',
    'settings.mediumPassword': '⚡ Medium',
    'settings.strongPassword': '✅ Strong',
    ...
    // Email Verified Success Page
    'emailVerified.title': 'Email Verified Successfully!',
    'emailVerified.success': 'Verification Successful',
    'emailVerified.message': 'Your account has been successfully verified. You can now log in and start using all platform features.',
    'emailVerified.loginButton': 'Login Now',
    'emailVerified.autoRedirect': 'Redirecting automatically in',
    'emailVerified.seconds': 'seconds',
    'emailVerified.info': 'If you are not redirected automatically, you can click the login button above.',
    ...
    'referral.subtitle': 'Share your link and earn rewards',
    'referral.yourLink': 'Your Referral Link',
    'referral.yourCode': 'Your Referral Code',
    'referral.copy': 'Copy',
    'referral.copied': 'Copied!',
    'referral.shareText': 'Join the trading platform using my referral link!',
    'referral.shareTitle': 'Referral Link',
    ...
    'referral.referralsList': 'Referrals List',
    'referral.noReferrals': 'No referrals yet',
    'referral.shareToStart': 'Share your link to start earning rewards',
    'referral.pendingUser': 'Pending User',
    'referral.howItWorks': 'How It Works?',
    'referral.step1': 'Share your referral link with friends',
    'referral.step2': 'When they sign up and subscribe, you get rewarded',
    'referral.step3': 'The more referrals, the more rewards',
    'referral.pendingCommissions': 'Your Pending Commissions',
    'referral.commissionsInfo': 'Paid every 15 days',
    'referral.couponUsage': 'Users can use this code as a discount coupon on the payment page',
    ...
    'paymentMethod.title': 'Commission Payment Methods',
    'paymentMethod.subtitle': 'Choose how to receive your commissions',
    'paymentMethod.addMethod': 'Add Method',
    'paymentMethod.addNew': 'Add New Payment Method',
    'paymentMethod.editMethod': 'Edit Payment Method',
    'paymentMethod.selectType': 'Payment Method Type',
    'paymentMethod.paypal': 'PayPal',
    'paymentMethod.bankTransfer': 'Bank Transfer',
    'paymentMethod.westernUnion': 'Western Union',
    'paymentMethod.cryptocurrency': 'Cryptocurrency',
    'paymentMethod.other': 'Other',
    'paymentMethod.paypalEmail': 'PayPal Email',
    'paymentMethod.bankName': 'Bank Name',
    'paymentMethod.accountHolder': 'Account Holder Name',
    'paymentMethod.accountNumber': 'Account Number',
    'paymentMethod.iban': 'IBAN',
    'paymentMethod.swiftCode': 'SWIFT Code',
    'paymentMethod.fullName': 'Full Name',
    'paymentMethod.country': 'Country',
    'paymentMethod.city': 'City',
    'paymentMethod.phone': 'Phone Number',
    'paymentMethod.cryptoType': 'Cryptocurrency Type',
    'paymentMethod.walletAddress': 'Wallet Address',
    'paymentMethod.details': 'Payment Method Details',
    'paymentMethod.save': 'Save',
    'paymentMethod.cancel': 'Cancel',
    'paymentMethod.saving': 'Saving...',
    'paymentMethod.primary': 'Primary',
    'paymentMethod.verified': 'Verified',
    'paymentMethod.setPrimary': 'Set as Primary',
    'paymentMethod.edit': 'Edit',
    'paymentMethod.delete': 'Delete',
    'paymentMethod.noMethods': 'No payment methods added yet',
    'paymentMethod.deleteConfirm': 'Are you sure you want to delete this payment method?',
    'paymentMethod.note': 'Your primary payment method will be used to transfer your commissions. Make sure the information is correct to avoid any delays.',
    'paymentMethod.notSet': 'No payment method set',
    'paymentMethod.required': 'Required fields',

    // Coupon System
    'coupon.management': 'Coupon Management',
    'coupon.subtitle': 'Create and manage discount coupons',
    'coupon.addNew': 'Add New Coupon',
    'coupon.totalCoupons': 'Total Coupons',
    'coupon.active': 'Active',
    'coupon.inactive': 'Inactive',
    'coupon.expired': 'Expired',
    'coupon.totalUses': 'Total Uses',
    'coupon.code': 'Code',
    ...
    'coupon.noExpiry': 'No Expiry',
    'coupon.deactivate': 'Deactivate',
    ...
    'coupon.fixedAmount': 'Fixed Amount',
    'coupon.discountValue': 'Discount Value',
    'coupon.maxUses': 'Max Uses',
    'coupon.optional': 'Optional',
    'coupon.unlimited': 'Unlimited',
    'coupon.update': 'Update',
    'coupon.create': 'Create',
    'coupon.cancel': 'Cancel',
    'coupon.confirmDelete': 'Are you sure you want to delete this coupon?',
    'coupon.haveCode': 'Have a discount code?',
    'coupon.enterCode': 'Enter coupon code',
    'coupon.apply': 'Apply',
    'coupon.checking': 'Checking...',
    'coupon.applied': 'Coupon Applied',
    'coupon.invalid': 'Invalid coupon code',
    'coupon.maxUsesReached': 'Maximum uses reached for this coupon',
    'coupon.alreadyUsed': 'You have already used this coupon',
    'coupon.error': 'Error verifying coupon',
    'coupon.discountRate': 'Discount Rate',
    'coupon.commissionRate': 'Commission Rate',
    'coupon.discountRateDesc': 'For new user (default: 10%)',
    'coupon.commissionRateDesc': 'For coupon owner (default: 10%)',
    'coupon.add': 'Add',

    // Commission Management
    'commission.management': 'Commission Management',
    'commission.subtitle': 'Review and pay referral commissions',
    'commission.total': 'Total',
    'commission.pending': 'Pending',
    'commission.totalPending': 'Due',
    'commission.totalPaid': 'Paid',
    'commission.searchByName': 'Search by name or email',
    'commission.filterByStatus': 'Filter by status',
    'commission.all': 'All',
    'commission.selectAll': 'Select All',
    'commission.paySelected': 'Pay Selected',
    'commission.noCommissions': 'No commissions',
    ...
    'commission.bankTransfer': 'Bank Transfer',
    'commission.paypal': 'PayPal',
    'commission.cryptocurrency': 'Cryptocurrency',
    'commission.cash': 'Cash',
    'commission.notes': 'Notes',
    'commission.notesPlaceholder': 'Add notes (optional)',
    'commission.confirmPayment': 'Confirm Payment',
    'commission.cancel': 'Cancel',
    'commission.selectCommissions': 'Please select commissions to pay',
    'commission.paymentSuccess': 'Commissions paid successfully',
    ...
    'terms.services.content': 'We provide educational trading signals based on AI.',
  ...
  fr: {
    ...
    'nav.subscription.desc': 'Gérez votre abonnement et suivez le statut des paiements',
    'nav.referral.desc': 'Invitez des amis et gagnez des récompenses',
    ...
    'settings.passwordTooWeak': 'Le mot de passe est trop faible. Utilisez majuscules, minuscules, chiffres et symboles',
    'settings.weakPassword': '⚠️ Faible',
    'settings.mediumPassword': '⚡ Moyen',
    'settings.strongPassword': '✅ Fort',
    ...
    'register.or': 'Ou',
    'register.googleButton': 'S\'inscrire avec Google',
    'register.googleLoading': 'Inscription avec Google...',
    ...
    // Email Verified Success Page
    'emailVerified.title': 'Email Vérifié avec Succès!',
    'emailVerified.success': 'Vérification Réussie',
    'emailVerified.message': 'Votre compte a été vérifié avec succès. Vous pouvez maintenant vous connecter et commencer à utiliser toutes les fonctionnalités de la plateforme.',
    'emailVerified.loginButton': 'Se Connecter Maintenant',
    'emailVerified.autoRedirect': 'Redirection automatique dans',
    'emailVerified.seconds': 'secondes',
    'emailVerified.info': 'Si vous n\'êtes pas redirigé automatiquement, vous pouvez cliquer sur le bouton de connexion ci-dessus.',
    ...
    'referral.subtitle': 'Partagez votre lien et gagnez des récompenses',
    ...
    'referral.shareText': 'Rejoignez la plateforme de trading avec mon lien de parrainage!',
    'referral.shareTitle': 'Lien de Parrainage',
    'referral.totalReferrals': 'Total des Parrainages',
    'referral.completed': 'Complétés',
    'referral.pending': 'En Attente',
    'referral.totalRewards': 'Total des Récompenses',
    'referral.referralsList': 'Liste des Parrainages',
    'referral.noReferrals': 'Aucun parrainage pour le moment',
    'referral.shareToStart': 'Partagez votre lien pour commencer à gagner des récompenses',
    'referral.pendingUser': 'Utilisateur en Attente',
    'referral.howItWorks': 'Comment ça Marche?',
    'referral.step1': 'Partagez votre lien de parrainage avec vos amis',
    'referral.step2': 'Quand ils s\'inscrivent et s\'abonnent, vous êtes récompensé',
    'referral.step3': 'Plus de parrainages, plus de récompenses',
    'referral.pendingCommissions': 'Vos Commissions en Attente',
    'referral.commissionsInfo': 'Payées tous les 15 jours',
    'referral.couponUsage': 'Les utilisateurs peuvent utiliser ce code comme coupon de réduction sur la page de paiement',
    ...
    // Méthodes de Réception des Commissions
    'paymentMethod.title': 'Méthodes de Paiement des Commissions',
    'paymentMethod.subtitle': 'Choisissez comment recevoir vos commissions',
    'paymentMethod.addMethod': 'Ajouter une Méthode',
    'paymentMethod.addNew': 'Ajouter une Nouvelle Méthode de Paiement',
    'paymentMethod.editMethod': 'Modifier la Méthode de Paiement',
    'paymentMethod.selectType': 'Type de Méthode de Paiement',
    'paymentMethod.paypal': 'PayPal',
    'paymentMethod.bankTransfer': 'Virement Bancaire',
    'paymentMethod.westernUnion': 'Western Union',
    'paymentMethod.cryptocurrency': 'Cryptomonnaie',
    'paymentMethod.other': 'Autre',
    'paymentMethod.paypalEmail': 'Email PayPal',
    'paymentMethod.bankName': 'Nom de la Banque',
    'paymentMethod.accountHolder': 'Nom du Titulaire du Compte',
    'paymentMethod.accountNumber': 'Numéro de Compte',
    'paymentMethod.iban': 'IBAN',
    'paymentMethod.swiftCode': 'Code SWIFT',
    'paymentMethod.fullName': 'Nom Complet',
    'paymentMethod.country': 'Pays',
    'paymentMethod.city': 'Ville',
    'paymentMethod.phone': 'Numéro de Téléphone',
    'paymentMethod.cryptoType': 'Type de Cryptomonnaie',
    'paymentMethod.walletAddress': 'Adresse du Portefeuille',
    'paymentMethod.details': 'Détails de la Méthode de Paiement',
    'paymentMethod.save': 'Enregistrer',
    'paymentMethod.cancel': 'Annuler',
    'paymentMethod.saving': 'Enregistrement...',
    'paymentMethod.primary': 'Principale',
    'paymentMethod.verified': 'Vérifiée',
    'paymentMethod.setPrimary': 'Définir comme Principale',
    'paymentMethod.edit': 'Modifier',
    'paymentMethod.delete': 'Supprimer',
    'paymentMethod.noMethods': 'Aucune méthode de paiement ajoutée',
    'paymentMethod.deleteConfirm': 'Êtes-vous sûr de vouloir supprimer cette méthode de paiement?',
    'paymentMethod.note': 'Votre méthode de paiement principale sera utilisée pour transférer vos commissions. Assurez-vous que les informations sont correctes pour éviter tout retard.',
    'paymentMethod.notSet': 'Aucune méthode de paiement définie',
    'paymentMethod.required': 'Champs obligatoires',

    // Système de Coupons
    'coupon.management': 'Gestion des Coupons',
    'coupon.subtitle': 'Créer et gérer les coupons de réduction',
    'coupon.addNew': 'Ajouter un Nouveau Coupon',
    'coupon.totalCoupons': 'Total des Coupons',
    'coupon.active': 'Actifs',
    'coupon.inactive': 'Inactifs',
    'coupon.expired': 'Expirés',
    'coupon.totalUses': 'Total des Utilisations',
    'coupon.code': 'Code',
    'coupon.discount': 'Réduction',
    'coupon.uses': 'Utilisations',
    'coupon.validUntil': 'Valide Jusqu\'à',
    'coupon.status': 'Statut',
    'coupon.actions': 'Actions',
    'coupon.noExpiry': 'Sans Expiration',
    'coupon.deactivate': 'Désactiver',
    'coupon.activate': 'Activer',
    'coupon.edit': 'Modifier',
    'coupon.delete': 'Supprimer',
    'coupon.noCoupons': 'Aucun coupon pour le moment',
    'coupon.addCoupon': 'Ajouter un Coupon',
    'coupon.editCoupon': 'Modifier le Coupon',
    'coupon.discountType': 'Type de Réduction',
    'coupon.percentage': 'Pourcentage',
    'coupon.fixedAmount': 'Montant Fixe',
    'coupon.discountValue': 'Valeur de la Réduction',
    'coupon.maxUses': 'Utilisations Maximales',
    'coupon.optional': 'Optionnel',
    'coupon.unlimited': 'Illimité',
    'coupon.update': 'Mettre à Jour',
    'coupon.create': 'Créer',
    'coupon.cancel': 'Annuler',
    'coupon.confirmDelete': 'Êtes-vous sûr de vouloir supprimer ce coupon?',
    'coupon.haveCode': 'Vous avez un code de réduction?',
    'coupon.enterCode': 'Entrez le code du coupon',
    'coupon.apply': 'Appliquer',
    'coupon.checking': 'Vérification...',
    'coupon.applied': 'Coupon Appliqué',
    'coupon.invalid': 'Code de coupon invalide',
    'coupon.maxUsesReached': 'Nombre maximum d\'utilisations atteint pour ce coupon',
    'coupon.alreadyUsed': 'Vous avez déjà utilisé ce coupon',
    'coupon.error': 'Erreur lors de la vérification du coupon',
    'coupon.discountRate': 'Taux de Réduction',
    'coupon.commissionRate': 'Taux de Commission',
    'coupon.discountRateDesc': 'Pour le nouvel utilisateur (par défaut: 10%)',
    'coupon.commissionRateDesc': 'Pour le propriétaire du coupon (par défaut: 10%)',
    'coupon.add': 'Ajouter',

    // Gestion des Commissions
    'commission.management': 'Gestion des Commissions',
    'commission.subtitle': 'Examiner et payer les commissions de parrainage',
    'commission.total': 'Total',
    'commission.pending': 'En Attente',
    'commission.totalPending': 'Dues',
    'commission.totalPaid': 'Payées',
    'commission.searchByName': 'Rechercher par nom ou email',
    'commission.filterByStatus': 'Filtrer par statut',
    'commission.all': 'Tous',
    'commission.selectAll': 'Tout Sélectionner',
    'commission.paySelected': 'Payer la Sélection',
    'commission.noCommissions': 'Aucune commission',
    'commission.referrer': 'Parrain',
    'commission.amount': 'Montant',
    'commission.subscription': 'Abonnement',
    'commission.rate': 'Taux',
    'commission.status': 'Statut',
    'commission.date': 'Date',
    'commission.paidDate': 'Date de Paiement',
    'commission.paid': 'Payée',
    'commission.cancelled': 'Annulée',
    'commission.paymentDetails': 'Détails du Paiement',
    'commission.paymentMethod': 'Méthode de Paiement',
    'commission.bankTransfer': 'Virement Bancaire',
    'commission.paypal': 'PayPal',
    'commission.cryptocurrency': 'Cryptomonnaie',
    'commission.cash': 'Espèces',
    'commission.notes': 'Notes',
    'commission.notesPlaceholder': 'Ajouter des notes (optionnel)',
    'commission.confirmPayment': 'Confirmer le Paiement',
    'commission.cancel': 'Annuler',
    'commission.selectCommissions': 'Veuillez sélectionner des commissions à payer',
    'commission.paymentSuccess': 'Commissions payées avec succès',
    ...
    'payment.originalPrice': 'Prix Original',
    ...
    'terms.services.title': 'Services',
    'terms.services.content': 'Nous fournissons des signaux de trading éducatifs basés sur l\'IA.',
